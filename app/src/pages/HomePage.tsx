...
export default function HomePage() {
  ...
  return (
    <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap gap-3 mb-10">
                ...
                <Link
                  to="/talent"
                  className="inline-flex items-center gap-2 px-6 py-3.5 border border-white/15 text-slate-200 rounded-xl text-sm font-medium hover:bg-white/5 hover:border-white/25 transition-all duration-300"
                >
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
                ...
                <div className="absolute bottom-4 left-4 right-4 flex gap-3">
                  <div className="flex-1 glass rounded-xl p-3">
                    ...
                    <div className="text-[10px] text-slate-400">Workers Placed</div>
                  </div>
                  <div className="flex-1 glass rounded-xl p-3">
      ...
      <section className="relative py-20 lg:py-28 bg-navy-900/30" ref={destRef}>
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {destinations.map((dest, i) => (
              <div
                key={dest.country}
                className="group relative p-5 rounded-2xl bg-surface-elevated border border-white/5 hover:border-brand-teal/30 transition-all duration-500 hover:-translate-y-1"
                style={{
                  opacity: destVisible ? 1 : 0,
                  transform: destVisible
                    ? 'translateY(0)'
                    : 'translateY(24px)',
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5 mb-4">
                  {dest.sectors.map(sector => (
                    <span
                      key={sector}
                      className="px-2 py-1 rounded-md bg-white/5 text-[10px] text-slate-400 border border-white/5"
                    >
                      {sector}
                    </span>
                  ))}
                ...
                <div className="flex items-center justify-between pt-3 border-t border-white/5">
                  <div>
                    <span className="text-[10px] text-slate-600 block">Avg. Salary</span>
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {trustBadges.map((badge, i) => (
              <div
                key={badge.label}
                className="text-center p-6 rounded-2xl bg-surface-elevated border border-white/5 hover:border-brand-gold/20 transition-all duration-500 group"
                style={{
          ...
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-navy-800 via-navy-900 to-navy-950 border border-white/5 p-10 lg:p-16 text-center">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                ...
                <Link
                  to="/employers"
                  className="inline-flex items-center gap-2 px-7 py-3.5 border border-white/15 text-slate-200 rounded-xl text-sm font-medium hover:bg-white/5 hover:border-white/25 transition-all duration-300"
                >
