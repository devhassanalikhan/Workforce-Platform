        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-2 text-sm text-muted-foreground">
              <span>{selectedCompany.jobCount} jobs posted</span>
              <span>{selectedCompany.applicationCount} applications</span>
              <span>{selectedCompany.shortlistedCount} shortlisted</span>
            ...
            <div className="space-y-3">
              {companyApplications.length === 0 ? (
                ...
                companyApplications.map(app => (
                  <div key={app.id} className="flex items-center justify-between gap-4 p-4 rounded-xl bg-card border border-border">
